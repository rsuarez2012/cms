							...
							<div class="opts">
								...
								@if(kvfj(Auth::user()->permissions, 'product_delete'))
									@if(is_null($product->deleted_at))
										<a href="#" data-action="delete" data-path="admin/product" data-object="{{ $product->id }}" data-toggle="tooltip" data-placement="top" title="Eliminar" class="btn-deleted"><i class="fa fa-trash"></i></a>
									@else
										<a href="{{ url('/admin/product/'.$product->id.'/restore') }}" data-action="restore" data-path="admin/product" data-object="{{ $product->id }}" data-toggle="tooltip" data-placement="top" title="Restaurar Producto" class="btn-deleted"><i class="fa fa-trash-restore"></i></a>
									@endif
								@endif
							</div>
						</td>
