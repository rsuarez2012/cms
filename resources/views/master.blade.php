...
<body>
	<nav class="navbar navbar-expand-lg shadow">
		<div class="container">
			<a class="navbar-brand" href="{{ url('/') }}"><img src="{{ url('/static/images/american-express.png') }}"></a>
		    ...
		    <div class="collapse navbar-collapse">
		    	<ul class="navbar-nav ml-auto">
		    		...
		    		<li class="nav-item">
		    			<a href="{{ url('/') }}" class="nav-link"><i class="far fa-envelope-open"></i> Contactanos</a>
		    		</li>
		    		<li class="nav-item">
		    			<a href="{{ url('/car') }}" class="nav-link"><i class="fas fa-shopping-cart"></i> <span class="car_number">2</span></a>
		    		</li>
		    		@if(Auth::guest())
		    		...
		    		@else
		    			<li class="nav-item link-user dropdown">
		    				<a href="#" class="nav-link dropdown-toggle" id="navbarDropdown" role="button" data-toggle="dropdown" aria-expanded="false">@if(is_null(Auth::user()->avatar)) <img src="{{ url('/static/images/avatar5.png') }}"> @endif Hola: {{ Auth::user()->name }}</a>
